...
@section('content')
<style>
    /* Background Animasi Biru Professional */
    body.login-bg {
        min-height: 100vh;
    ...
    <div class="row justify-content-center align-items-center min-vh-100">
        <div class="col-lg-6 d-none d-lg-flex flex-column align-items-center justify-content-center text-white p-5">
            <div class="animate__animated animate__fadeInLeft text-center">
                ...
                <p class="lead opacity-75 mt-3">Satu akun untuk semua akses layanan premium kami. Cepat, Aman, & Modern.</p>
        ...
        <div class="col-lg-5 col-md-8">
            <div class="login-glass p-4 p-md-5 animate__animated animate__fadeInUp">
                <div class="text-center mb-5">
                    <h2 class="fw-bold text-dark mb-2">Login Akun</h2>
                    <p class="text-muted small">Silakan masukkan detail akun Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 px-1">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input shadow-none" name="remember" id="remember">
                            <label class="form-check-label small text-muted" for="remember">Biarkan saya tetap masuk</label>
                        </div>
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="login-link small text-primary text-decoration-none">Lupa Sandi?</a>
                        @endif
                    </div>

                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary login-btn shadow-lg">
                            Login Sekarang <i class="bi bi-door-open ms-2"></i>
                        </button>
                    </div>

                    <div class="hr-text my-4 small fw-bold">OR LOGIN WITH</div>
                    ...
                    <p class="text-center mt-5 mb-0 small text-muted">
                        Tidak punya akses? <a href="{{ route('register') }}" class="login-link">Buat Akun Baru</a>
                    </p>
                </form>
            </div>
        </div>
